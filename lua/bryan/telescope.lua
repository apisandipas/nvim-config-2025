...
M.config = function()
  ...
  wk.add({
    { "<leader>f", group = "+find" },
    { "<leader>fb", "<cmd>Telescope get_branches<CR>", desc = "Checkout branch" },
    { "<leader>fc", "<cmd>Telescope colorsceme<CR>", desc = "Colorschemes" },
    { "<leader>ff", "<cmd>Telescope find_files<CR>", desc = "Find files" },
    { "<leader>fp", "<cmd>Telescope live_grep<CR>", desc = "Find Text" },
